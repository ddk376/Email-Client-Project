...
usser = User.create({email:"test@noofel.com", password: "password"}).associated_contact_info
...
email2a = email2.children_emails.create(from: "test1@noofel.com", body: "kakajlksjfjsafl", is_starred: false, is_draft: false, is_read: false, sent: true, to: ["test2@noofel.com", "ddk376@gmail.com"], to_bcc: ["test2@noofel.com"], to_cc: ["test3.noofel.com"])
